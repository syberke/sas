...
@section('content')
                        ...
                        <tbody>
                            @forelse ($futsal as $item)
                                ...
                                <div class="modal modal-blur fade" id="modal-delete-{{ $item->id }}" tabindex="-1"
                                    ...
                                    <form action="{{ route('futsal.delete', $item->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
    ...
    <div class="modal modal-blur fade" id="modal-create" tabindex="-1" role="dialog" aria-hidden="true">
        <form action="{{ route('futsal.perform') }}" method="POST">
            @csrf
    ...
    @foreach ($futsal as $item)
        <div class="modal modal-blur fade" id="modal-update-{{ $item->id }}" tabindex="-1" role="dialog"
            aria-hidden="true">
            <form action="{{ route('futsal.update', $item->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
